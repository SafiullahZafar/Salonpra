...
@section('page-sub', 'Bundle services into an attractive promotional package.')
...
<div class="pkg-form-wrap">
    ...
    <div class="form-header">
        <div>
            <h1 class="form-title">Create Package</h1>
            <p class="form-sub">Bundle services into an attractive promotional offer.</p>
        </div>
    ...
    <form action="{{ route('packages.store') }}" method="POST" id="pkg-form">
        @csrf
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                        <div class="field">
                            ...
                            <input type="text" name="name" placeholder="e.g. Bridal Glow Bundle" required value="{{ old('name') }}">
                        ...
                        <div class="field">
                            ...
                            <textarea name="description" placeholder="Describe what's included in this package…">{{ old('description') }}</textarea>
                            @error('description')<p class="error">{{ $message }}</p>@enderror
                        </div>
                        <div class="field-row">
                            <div class="field">
                                <label>Price (PKR)</label>
                                <input type="number" name="price" id="pkg-price" placeholder="0" required step="0.01" min="0" value="{{ old('price') }}" oninput="updateSummary()">
                                @error('price')<p class="error">{{ $message }}</p>@enderror
                            </div>
                            <div class="field">
                                <label>Duration (Minutes)</label>
                                <input type="number" name="duration" id="pkg-duration" placeholder="60" required min="1" value="{{ old('duration') }}" oninput="updateSummary()">
            ...
            <div>
                <div class="sidebar-card">
                    <div class="sidebar-body">
                        ...
                        <a href="{{ route('packages.index') }}" class="btn-discard">Discard</a>

                        <p class="sidebar-note">This package will be available in POS immediately after creation.</p>
