...
<head>
    ...
    <title>Forgot Password — {{ config('app.name', 'The Crimpers') }}</title>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn{width:100%;height:48px;border:none;border-radius:12px;background:#F7DF79;color:#111827;font-size:14px;font-weight:900;letter-spacing:.06em;cursor:pointer;transition:all .2s;font-family:'Outfit',sans-serif;box-shadow:0 4px 14px rgba(247,223,121,.4);margin-bottom:14px}
        .btn:hover{background:#fde047;transform:translateY(-1px)}
        .back-link{display:block;text-align:center;font-size:13px;color:#9ca3af;font-weight:600;text-decoration:none;transition:color .2s;margin-top:10px}
...
<body>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-sub">Enter the email address associated with your account, and we'll email you a password reset link.</p>
